...
public class Table implements Serializable {
	...
	protected ArrayList<Integer> pageAddress;
	...
	protected void insertInPage(int pageNum, ArrayList<String> record) throws IOException {
	...
	protected int compare(String s, String ss, String dataType) {
		switch (dataType) {
...
//		String s = "";
//		for (int i = 0; i < pageAddress.size(); i++) {
//			s += decerialize(pageAddress.get(i)) + "/";
//		}
//		s += System.lineSeparator() + "min:" + min + System.lineSeparator() + "max:" + max + System.lineSeparator()
